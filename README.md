...
22 AWS services, 1155 API operations:
...
| **Bedrock**            | 101     | Foundation models, guardrails (CRUD, versioning, content evaluation, enforced configs), custom models, model deployments, import/copy jobs, invocation jobs, evaluation jobs, inference profiles, prompt routers, resource policies, marketplace endpoints, foundation model agreements, automated reasoning policies (CRUD, versions, test cases, build workflows, annotations)                              |
| **Bedrock Runtime**    | 10      | InvokeModel (Anthropic, Titan, Meta, Cohere, Mistral), Converse, streaming (response + bidirectional), ApplyGuardrail, CountTokens, async invoke (start, get, list)                                                                                                                                                                                                                                       |
