...
- `fakecloud-{sqs,sns,eventbridge,iam,ssm,dynamodb,s3,logs,kms}` — individual service implementations
- `fakecloud-{sqs,sns,eventbridge,iam,ssm,lambda,secretsmanager,s3,logs,kms}` — individual service implementations
